...
[TestClass]
public class TestLurchTable : TestGenericCollection<LurchTable<int, string>, KeyValuePair<int, string>>
{
    protected override LurchTable<int, string> CollectionFactory()
    {
        return new LurchTable<int, string>(1024, LurchTableOrder.Access);
    }
    ...
    {
        var test = new LurchTable<int, string>(LurchTableOrder.Insertion, 1024 );
    ...
    {
        var test = new LurchTable<int, string>(LurchTableOrder.Modified, 1024);
    ...
    {
        var test = new LurchTable<int, string>(LurchTableOrder.Access, 1024);
    ...
    {
        var test = new LurchTable<string, string>(1024, LurchTableOrder.Access, StringComparer.OrdinalIgnoreCase);
        test["a"] = "b";
        Assert.IsTrue(test.ContainsKey("A"));

        test = new LurchTable<string, string>(1024, LurchTableOrder.Access, StringComparer.OrdinalIgnoreCase);
        test["a"] = "b";
        Assert.IsTrue(test.ContainsKey("A"));
    }
    ...
    {
        var test = new LurchTable<string, string>(LurchTableOrder.Access, 1024);
        test["a"] = "b";
   ...
   [TestMethod]
    ...
    {
        var data = new LurchTable<int, string>(LurchTableOrder.Access, 1024);
    ...
    {
        var test = new LurchTable<string, string>(LurchTableOrder.Access, 1024,StringComparer.Ordinal);
        test["a"] = "b";
