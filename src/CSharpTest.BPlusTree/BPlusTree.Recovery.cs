...
partial class BPlusTree<TKey, TValue>
{
	...
	//		throw new InvalidConfigurationValueException("The FileName property was not specified.");
	//	if (!File.Exists(filename))
	//		throw new InvalidConfigurationValueException("The FileName specified does not exist.");
	//	if (options.StorageType != StorageType.Disk)
	//		throw new InvalidConfigurationValueException("The storage type is not set to 'Disk'.");
	...
	//	try
	//	{
	//		var tmpoptions = options.Clone();
	//		tmpoptions.CreateFile = CreatePolicy.Always;
	//		tmpoptions.FileName = tmpfilename;
	//		tmpoptions.LockingFactory = new IgnoreLockFactory();
	...
	//	var toptions = new TransactedCompoundFile.Options(filename);
	//	toptions.BlockSize = options.FileBlockSize;
	//	toptions.FileOptions = FileOptions.None;
	//	using var file = new TransactedCompoundFile(toptions);
