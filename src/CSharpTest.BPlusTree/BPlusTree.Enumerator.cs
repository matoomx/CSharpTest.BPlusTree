...
partial class BPlusTree<TKey, TValue>
{
    class Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        public Enumerator(BPlusTree<TKey, TValue> tree, TKey startKey, Predicate<KeyValuePair<TKey, TValue>> fnContinue) : this(tree, startKey)
        {
        ...
        private bool SeekNext(NodePin thisLock, TKey key, out NodePin pin, out int offset, out TKey nextKey, out bool hasMore)
        {
            ...
            try
            {
				...
				{
					Node me = current.Ptr;
					me.BinarySearch(_tree._itemComparer, find, out int ordinal);
					if (me.IsLeaf)
					{
						pin = current;
						offset = ordinal;
