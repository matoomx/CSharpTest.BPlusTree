...
partial class BPlusTree<TKey, TValue>
{
    ...
    abstract class NodeCacheBase : IDisposable
    {
        ...
        public static void ReturnVersion(ref NodeVersion ver) { /*if (_version is NodePin) new NodeVersion().ChainTo(ref _version);*/ GC.KeepAlive(ver); }
        ...
        protected RootNode CreateRoot(NodeHandle rootHandle)
        {
            NodeHandle hChild;
			...
			ILockStrategy lck = CreateLock(rootHandle, out object refobj);
