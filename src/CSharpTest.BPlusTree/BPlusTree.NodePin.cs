...
partial class BPlusTree<TKey, TValue>
{
    ...
    class NodePin : NodeVersion, IDisposable
    {
        ...
        {
            Check.Assert(original == null || original.IsReadOnly, "Original is null or readonly");
            _handle = handle;
            _lock = lck;
            _ltype = ltype;
            _lockHeld = lockHeld;
        ...
        public void BeginUpdate()
        {
			...
			Check.Assert(_temp == null, "Node is already in a transaction");
			Check.Assert(_deleted == false, "Node is already marked for deletion");
